...
create table `bank_account`(
	...
	`a_c_no` varchar(14) not null unique,
	`a_balance` int default 0 not null,
    `a_opeb_date` datetime not null
);
...
insert into `bank_account` values('101-22-1006','L2','예금담보대출','930423-1000001',25000,'2013-12-11');
...
#실습 2-15
select sum(t_amount) as '입금총합' , avg(t_amount) as '입금 평균' 
...
select 
`a_no`as '계좌번호',`a_item_name` as '계좌이름' ,`a_c_no` as '주민번호',
