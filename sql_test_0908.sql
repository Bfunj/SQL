...
insert into `departments` values ('103','외과','장보고','051-123-01013');
...
insert into `departments` values ('107','흉부외과','류상룡','051-123-0107');
...
insert into `doctors` values ('D107104','이황','1979-12-09','M','107','전문의','010-7104-1989','hwang@bw.com');
insert into `doctors` values ('D108101','송상헌','1977-03-14','M','108','과장','010-8101-1977','ssh@bw.com');
...
insert into `patients` values ('P104101','D104101','N104101','이나영','790413-1234567','F','대전','010-2101-7904','lee@naver.com','회사운');
insert into `patients` values ('P105101','D105101','N105101','원빈','660912-1234567','M','대전','010-2104-6609','one@daum.net','배우');
insert into `patients` values ('P103102','D103101','N103101','장동건','790728-1234567','M','대전','010-3101-7907','jang@naver.com','배우');
