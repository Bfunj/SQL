# 학생
insert into `students` (`stdNo`,`Departments_depNo`,`Professors_proNo`,`stdName`,`stdJumin`,`stdHp`,`stdAddr`)
values ('20101001','10','P10101','정우성','760121-1234567','010-1001-7601','서울');
insert into `students`(`stdNo`,`Departments_depNo`,`Professors_proNo`,`stdName`,`stdJumin`,`stdHp`,`stdAddr`)
...
insert into `register` (`Students_stdNo`,`Lectures_lecNo`,`Lectures_Professors_proNo`)
