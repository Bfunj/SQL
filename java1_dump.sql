...
DROP DATABASE IF EXISTS `java1_bank`;
CREATE DATABASE IF NOT EXISTS `java1_bank` ;
USE `java1_bank`;
...
CREATE TABLE IF NOT EXISTS `bank_account` (
  ...
  PRIMARY KEY (`a_no`),
  UNIQUE KEY `a_c_no` (`a_c_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- 테이블 데이터 java1_bank.bank_account:~10 rows (대략적) 내보내기
INSERT INTO `bank_account` (`a_no`, `a_item_dist`, `a_item_name`, `a_c_no`, `a_balance`, `a_opeb_date`) VALUES
	('101-11-1001', 'S1', '자유저축예금', '730423-1000001', 380000, '2005-07-21 00:00:00'),
	('101-11-1003', 'S1', '자유저축예금', '870830-1000004', 53000, '2007-02-17 00:00:00'),
	...
	('101-11-2003', 'S1', '자유저축예금', '102-22-51094', 8325010, '2010-06-07 00:00:00'),
	...
	('101-22-1006', 'L2', '예금담보대출', '930423-1000001', 55000, '2013-12-11 00:00:00'),
...
DROP DATABASE IF EXISTS `java1_board`;
CREATE DATABASE IF NOT EXISTS `java1_board` ;
USE `java1_board`;
...
CREATE TABLE IF NOT EXISTS `board_article` (
  ...
  PRIMARY KEY (`no`)
) ENGINE=InnoDB AUTO_INCREMENT=8773 DEFAULT CHARSET=utf8mb4;

-- 테이블 데이터 java1_board.board_article:~15 rows (대략적) 내보내기
INSERT INTO `board_article` (`no`, `parent`, `comment`, `cate`, `title`, `content`, `file`, `hit`, `uid`, `regip`, `rdate`) VALUES
	(8706, 0, 0, 'free', '내가 쓴거야', 'tt', 0, 7, 'baekhj1', '0:0:0:0:0:0:0:1', '2022-11-03 09:52:24'),
	(8709, 0, 0, 'free', '내가 쓴거야', '4페이지', 0, 23, 'baekhj1', '0:0:0:0:0:0:0:1', '2022-11-03 09:56:09'),
	(8712, 0, 0, 'free', '내가 쓴거야', '', 0, 11, 'baekhj1', '0:0:0:0:0:0:0:1', '2022-10-27 09:28:50'),
	(8728, 0, 0, 'free', 'gdf', '', 0, 11, 'baekhj9', '0:0:0:0:0:0:0:1', '2022-10-31 09:55:47'),
	(8730, 8712, 4444, 'free', NULL, NULL, 0, 0, 'baekhj9', '0:0:0:0:0:0:0:1', '2022-11-01 09:39:20'),
	(8731, 0, 0, 'free', '5', '555', 0, 2, 'baekhj9', '0:0:0:0:0:0:0:1', '2022-11-01 09:39:59'),
	(8732, 0, 0, 'free', '55', '345', 0, 3, 'baekhj9', '0:0:0:0:0:0:0:1', '2022-11-01 09:40:02'),
	(8733, 0, 0, 'free', '756756', '75', 0, 5, 'baekhj9', '0:0:0:0:0:0:0:1', '2022-11-01 09:40:06'),
	(8751, 8709, NULL, 'free', NULL, 'ㄹㄹ', 0, 0, 'baekhj9', '0:0:0:0:0:0:0:1', '2022-11-01 12:21:38'),
	(8752, 8709, NULL, 'free', NULL, '댓글 작성', 0, 0, 'baekhj9', '0:0:0:0:0:0:0:1', '2022-11-01 12:21:56'),
	(8753, 8709, NULL, 'free', NULL, 'eoeot', 0, 0, 'baekhj9', '0:0:0:0:0:0:0:1', '2022-11-01 12:23:15'),
	(8754, 8709, NULL, 'free', NULL, 'fff', 0, 0, 'baekhj9', '0:0:0:0:0:0:0:1', '2022-11-01 12:24:09'),
	(8755, 8709, NULL, 'free', NULL, '댓글', 0, 0, 'baekhj9', '0:0:0:0:0:0:0:1', '2022-11-01 12:25:48'),
	(8771, 8733, NULL, 'free', NULL, 'ㅋㅋㅋㅋㅋㅋ', 0, 0, 'baekhj1', '0:0:0:0:0:0:0:1', '2022-11-03 11:24:05'),
	(8772, 8712, NULL, 'free', NULL, 'ㅎㅇㅎㅇ', 0, 0, 'baekhj1', '0:0:0:0:0:0:0:1', '2022-11-03 11:24:14');
...
-- 테이블 데이터 java1_board.board_file:~2 rows (대략적) 내보내기
INSERT INTO `board_file` (`fno`, `parent`, `newname`, `oriname`, `download`, `rdate`) VALUES
	(11, 8768, '20221103111306_baekhj9.png', 'footer_tel1.png', 0, '2022-11-03 11:13:06'),
	(12, 8769, '20221103111749_baekhj9.jpg', 'main_go_banner5.jpg', 0, '2022-11-03 11:17:49');

-- 테이블 java1_board.board_terms 구조 내보내기
DROP TABLE IF EXISTS `board_terms`;
...
-- 테이블 데이터 java1_board.board_user:~7 rows (대략적) 내보내기
INSERT INTO `board_user` (`uid`, `pass`, `name`, `nick`, `email`, `hp`, `grade`, `zip`, `addr1`, `addr2`, `regip`, `rdate`) VALUES
	('abcd3', 'qwop123!', '손오공', '사이어인', 'son@son.com', '010-1234-1234', 2, NULL, NULL, NULL, '0:0:0:0:0:0:0:1', '2022-10-24 11:35:20'),
	('asd145', '2ab9ab3905c032b0ae88f0e493257d04b27a139f8f98502cbbf852326b20aa03', '베지터', '만년2등', 'sian@power.com', '010-4515-8854', 2, NULL, NULL, NULL, '0:0:0:0:0:0:0:1', '2022-10-24 11:48:37'),
	('baekhj1', 'd9b4fa6ec0833acea5425b1e7eeeff37c16a19cb6c8568b50616de516f215726', '일현조', '없음', 'army1@naver.com', '011-1234-1112', 2, '', '', '', '0:0:0:0:0:0:0:1', '2022-10-27 09:25:29'),
	('baekhj9', 'd9b4fa6ec0833acea5425b1e7eeeff37c16a19cb6c8568b50616de516f215726', '뻔조', '펀조', 'baekhj9@naver.com', '010-5509-0562', 2, '50834', '경남 김해시 인제로 197', '장영실관 238-2호', '0:0:0:0:0:0:0:1', '2022-10-25 09:53:15'),
	('iptest', 'ipiq123', '아이피', '아이큐', 'ipiq@naver.com', '010-1212-3434', 2, NULL, NULL, NULL, '0:0:0:0:0:0:0:1', '2022-10-19 09:51:24'),
	('krig2', 'fdd73f62a5e0d9b3bdb932a3557a223732b5b9199b9a799f12ddd21e1cd30bdf', '크리링', '대머리', 'head@head.com', '010-7745-9512', 2, '08386', '서울 구로구 구로동로 2', '59-12', '0:0:0:0:0:0:0:1', '2022-10-24 12:46:22'),
	('qwer123', 'aqwsed1234', '육군', '일병', 'army@naver.com', '010-1111-1111', 2, NULL, NULL, NULL, NULL, '2022-10-19 09:44:16');


-- java1_bookstore 데이터베이스 구조 내보내기
DROP DATABASE IF EXISTS `java1_bookstore`;
CREATE DATABASE IF NOT EXISTS `java1_bookstore` ;
USE `java1_bookstore`;
...
-- 테이블 데이터 java1_bookstore.book:~7 rows (대략적) 내보내기
...
-- 테이블 데이터 java1_bookstore.customer:~4 rows (대략적) 내보내기
INSERT INTO `customer` (`cusId`, `name`, `address`, `phone`) VALUES
	(1, '박지캐슬', '영국 맨체스타', '000-5000-0001'),
	(2, '김연아', '대한민국 서울', '000-6000-0001'),
	(3, '장미란', '대한민국 강원도', '000-7000-0001'),
	(4, '추신수', '미국 클리블랜드', '000-8000-0001');

-- 테이블 java1_bookstore.order 구조 내보내기
...
-- 테이블 데이터 java1_bookstore.order:~10 rows (대략적) 내보내기
...
DROP DATABASE IF EXISTS `java1_college`;
CREATE DATABASE IF NOT EXISTS `java1_college` ;
USE `java1_college`;
...
-- 테이블 데이터 java1_college.student:~10 rows (대략적) 내보내기
INSERT INTO `student` (`stdNo`, `stdName`, `stdHp`, `stdYear`, `stdAddress`) VALUES
	('20132863', '백현조', '010-5509-0562', 28, '서울 강남구'),
	...
	('20220522', '이승기', '010-1212-5555', 1, NULL),
	('20230511', '강호동', '010-8585-4541', 2, NULL),
	('20230601', '이수근', '010-1231-5477', 2, '호동이 옆집');


-- java1_hospital 데이터베이스 구조 내보내기
DROP DATABASE IF EXISTS `java1_hospital`;
CREATE DATABASE IF NOT EXISTS `java1_hospital` ;
USE `java1_hospital`;
...
CREATE TABLE IF NOT EXISTS `charts` (
  ...
  `Treatments_treat_no` int NOT NULL,
  `Treatments_Doctors_doc_Id` char(7) NOT NULL,
  `Treatments_patients_pat_id` char(7) NOT NULL,
  `chart_content` varchar(255) NOT NULL,
  PRIMARY KEY (`chart_id`,`Treatments_treat_no`,`Treatments_Doctors_doc_Id`,`Treatments_patients_pat_id`),
  KEY `fk_Charts_Treatments1_idx` (`Treatments_treat_no`,`Treatments_Doctors_doc_Id`,`Treatments_patients_pat_id`),
  CONSTRAINT `fk_Charts_Treatments1` FOREIGN KEY (`Treatments_treat_no`, `Treatments_Doctors_doc_Id`, `Treatments_patients_pat_id`) REFERENCES `treatments` (`treat_no`, `Doctors_doc_Id`, `patients_pat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_hospital.charts:~12 rows (대략적) 내보내기
INSERT INTO `charts` (`chart_id`, `Treatments_treat_no`, `Treatments_Doctors_doc_Id`, `Treatments_patients_pat_id`, `chart_content`) VALUES
...
CREATE TABLE IF NOT EXISTS `doctors` (
  ...
  `Departments_dep_no` char(3) NOT NULL,
  ...
  KEY `fk_Doctors_Departments_idx` (`Departments_dep_no`),
  CONSTRAINT `fk_Doctors_Departments` FOREIGN KEY (`Departments_dep_no`) REFERENCES `departments` (`dep_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_hospital.doctors:~12 rows (대략적) 내보내기
INSERT INTO `doctors` (`doc_Id`, `doc_name`, `doc_birth`, `doc_gen`, `Departments_dep_no`, `doc_pos`, `doc_phone`, `doc_email`) VALUES
	...
	('D107104', '이황', '1979-12-09', 'M', '107', '전문의', '010-7104-1989', 'hwang@bw.com'),
	('D108101', '송상헌', '1977-03-14', 'M', '108', '과장', '010-8101-1977', 'ssh@bw.com');

-- 테이블 java1_hospital.nurses 구조 내보내기
DROP TABLE IF EXISTS `nurses`;
CREATE TABLE IF NOT EXISTS `nurses` (
  `nur_id` char(7) NOT NULL,
  `nur_name` char(45) NOT NULL,
  ...
  KEY `fk_nurses_Departments1_idx` (`Departments_dep_no`),
  CONSTRAINT `fk_nurses_Departments1` FOREIGN KEY (`Departments_dep_no`) REFERENCES `departments` (`dep_no`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_hospital.nurses:~10 rows (대략적) 내보내기
INSERT INTO `nurses` (`nur_id`, `nur_name`, `nur_birth`, `nur_gender`, `Departments_dep_no`, `nur_pos`, `nur_phone`, `nur_email`) VALUES
...
CREATE TABLE IF NOT EXISTS `patients` (
  ...
  `Doctors_doc_Id` char(7) NOT NULL,
  `nurses_nur_id` char(7) NOT NULL,
  ...
  PRIMARY KEY (`pat_id`),
  UNIQUE KEY `par_jumin_UNIQUE` (`pat_jumin`),
  UNIQUE KEY `pat_phone_UNIQUE` (`pat_phone`),
  UNIQUE KEY `pat_email_UNIQUE` (`pat_email`),
  KEY `fk_patients_Doctors1_idx` (`Doctors_doc_Id`),
  KEY `fk_patients_nurses1_idx` (`nurses_nur_id`),
  CONSTRAINT `fk_patients_Doctors1` FOREIGN KEY (`Doctors_doc_Id`) REFERENCES `doctors` (`doc_Id`),
  CONSTRAINT `fk_patients_nurses1` FOREIGN KEY (`nurses_nur_id`) REFERENCES `nurses` (`nur_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_hospital.patients:~12 rows (대략적) 내보내기
INSERT INTO `patients` (`pat_id`, `Doctors_doc_Id`, `nurses_nur_id`, `pat_name`, `pat_jumin`, `pat_gen`, `pat_addr`, `pat_phone`, `pat_email`, `pat_job`) VALUES
	...
	('P103102', 'D103101', 'N103101', '장동건', '790728-1234567', 'M', '대전', '010-3101-7907', 'jang@naver.com', '배우'),
	('P104101', 'D104101', 'N104101', '이나영', '790413-1234567', 'F', '대전', '010-2101-7904', 'lee@naver.com', '회사운'),
...
CREATE TABLE IF NOT EXISTS `treatments` (
  ...
  `Doctors_doc_Id` char(7) NOT NULL,
  `patients_pat_id` char(7) NOT NULL,
  `treat_contents` varchar(255) NOT NULL,
  `treat_datetime` datetime NOT NULL,
  PRIMARY KEY (`treat_no`,`Doctors_doc_Id`,`patients_pat_id`),
  KEY `fk_Treatments_Doctors1_idx` (`Doctors_doc_Id`),
  KEY `fk_Treatments_patients1_idx` (`patients_pat_id`),
  CONSTRAINT `fk_Treatments_Doctors1` FOREIGN KEY (`Doctors_doc_Id`) REFERENCES `doctors` (`doc_Id`),
  CONSTRAINT `fk_Treatments_patients1` FOREIGN KEY (`patients_pat_id`) REFERENCES `patients` (`pat_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_hospital.treatments:~12 rows (대략적) 내보내기
INSERT INTO `treatments` (`treat_no`, `Doctors_doc_Id`, `patients_pat_id`, `treat_contents`, `treat_datetime`) VALUES
...
-- java1_md_company 데이터베이스 구조 내보내기
DROP DATABASE IF EXISTS `java1_md_company`;
CREATE DATABASE IF NOT EXISTS `java1_md_company` ;
USE `java1_md_company`;

-- 테이블 java1_md_company.department 구조 내보내기
...
-- 테이블 데이터 java1_md_company.department:~0 rows (대략적) 내보내기

-- 테이블 java1_md_company.member 구조 내보내기
...
-- 테이블 데이터 java1_md_company.member:~0 rows (대략적) 내보내기

-- 테이블 java1_md_company.sales 구조 내보내기
...
-- 테이블 데이터 java1_md_company.sales:~0 rows (대략적) 내보내기


-- java1_shop 데이터베이스 구조 내보내기
DROP DATABASE IF EXISTS `java1_shop`;
CREATE DATABASE IF NOT EXISTS `java1_shop` ;
USE `java1_shop`;
...
-- 테이블 데이터 java1_shop.customer:~11 rows (대략적) 내보내기
INSERT INTO `customer` (`custid`, `name`, `hp`, `addr`, `rdate`) VALUES
	('C001', '가시고기', '010-11', '우주 저편', '2022-10-14 13:28:50'),
	...
	('G001', 'AAA', '011', '대리점', '2022-10-14 13:29:23');
...
-- 테이블 데이터 java1_shop.order:~13 rows (대략적) 내보내기
INSERT INTO `order` (`orderNo`, `orderid`, `orderproduct`, `ordercount`, `orderdate`) VALUES
	...
	(11, 'c101', 1, 11, '2022-10-28 12:56:11'),
	(12, 'C001', 4, 500, '2022-10-28 13:00:23'),
	(13, 'c107', 3, 50, '2022-10-28 13:01:04');
...
DROP DATABASE IF EXISTS `java1_shoppingmall`;
CREATE DATABASE IF NOT EXISTS `java1_shoppingmall` ;
...
CREATE TABLE IF NOT EXISTS `carts` (
  ...
  `Products_prodNo` int NOT NULL,
  `cartProdCount` int DEFAULT '1',
  `cartProdDate` datetime NOT NULL,
  PRIMARY KEY (`cartNo`,`Users_userid`,`Products_prodNo`),
  KEY `fk_table1_Products1_idx` (`Products_prodNo`),
  KEY `fk_table1_Users1` (`Users_userid`),
  CONSTRAINT `fk_table1_Products1` FOREIGN KEY (`Products_prodNo`) REFERENCES `products` (`prodNo`),
  CONSTRAINT `fk_table1_Users1` FOREIGN KEY (`Users_userid`) REFERENCES `users` (`userid`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_shoppingmall.carts:~10 rows (대략적) 내보내기
INSERT INTO `carts` (`cartNo`, `Users_userid`, `Products_prodNo`, `cartProdCount`, `cartProdDate`) VALUES
...
CREATE TABLE IF NOT EXISTS `orderitems` (
  ...
  `Orders_orderNo` char(11) NOT NULL,
  `Products_prodNo` int NOT NULL,
  `itemPrice` int NOT NULL,
  `itemDiscount` tinyint NOT NULL,
  `itemCount` int DEFAULT '1',
  PRIMARY KEY (`itemNo`,`Orders_orderNo`,`Products_prodNo`),
  KEY `fk_OrderItems_Orders1_idx` (`Orders_orderNo`),
  KEY `fk_OrderItems_Products1_idx` (`Products_prodNo`),
  CONSTRAINT `fk_OrderItems_Orders1` FOREIGN KEY (`Orders_orderNo`) REFERENCES `orders` (`orderNo`),
  CONSTRAINT `fk_OrderItems_Products1` FOREIGN KEY (`Products_prodNo`) REFERENCES `products` (`prodNo`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_shoppingmall.orderitems:~13 rows (대략적) 내보내기
INSERT INTO `orderitems` (`itemNo`, `Orders_orderNo`, `Products_prodNo`, `itemPrice`, `itemDiscount`, `itemCount`) VALUES
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `orderDate` datetime NOT NULL,
  PRIMARY KEY (`orderNo`,`Users_userid`),
...
INSERT INTO `orders` (`orderNo`, `Users_userid`, `orderTotalPrice`, `orderAddr`, `orderStatus`, `orderDate`) VALUES
	('22010210001', 'user2', 52300, '서울시 마포구 121', 1, '2022-01-10 10:50:12'),
	('22010210002', 'user3', 56700, '서울시 강남구 21-1', 1, '2022-01-10 10:50:12'),
	('22010210010', 'user4', 72000, '서울시 강서구 큰대로 38', 2, '2022-01-10 10:50:12'),
...
CREATE TABLE IF NOT EXISTS `points` (
  ...
  PRIMARY KEY (`pointNo`),
  KEY `fk_Points_Users_idx` (`Users_userid`),
  CONSTRAINT `fk_Points_Users` FOREIGN KEY (`Users_userid`) REFERENCES `users` (`userid`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_shoppingmall.points:~10 rows (대략적) 내보내기
INSERT INTO `points` (`pointNo`, `Users_userid`, `point`, `pointDesc`, `pointDate`) VALUES
...
CREATE TABLE IF NOT EXISTS `products` (
  `prodNo` int NOT NULL,
  `Categories_cateNo` int NOT NULL,
  `Sellers_sellerNo` int NOT NULL,
  `prodName` varchar(20) NOT NULL,
  `prodPrice` int NOT NULL,
  `prodStock` int DEFAULT '0',
  `prodSold` int DEFAULT '0',
  `prodDiscount` tinyint DEFAULT '0',
  PRIMARY KEY (`prodNo`,`Categories_cateNo`),
  KEY `fk_Products_Sellers1_idx` (`Sellers_sellerNo`),
  KEY `fk_Products_Categories1_idx` (`Categories_cateNo`),
  CONSTRAINT `fk_Products_Categories1` FOREIGN KEY (`Categories_cateNo`) REFERENCES `categories` (`cateNo`),
  CONSTRAINT `fk_Products_Sellers1` FOREIGN KEY (`Sellers_sellerNo`) REFERENCES `sellers` (`sellerNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_shoppingmall.products:~10 rows (대략적) 내보내기
INSERT INTO `products` (`prodNo`, `Categories_cateNo`, `Sellers_sellerNo`, `prodName`, `prodPrice`, `prodStock`, `prodSold`, `prodDiscount`) VALUES
	...
	(141001, 14, 10001, '라떼 2인 소파/방수 패브릭', 0, 320000, 42, 0),
...
CREATE TABLE IF NOT EXISTS `sellers` (
  ...
  `sellerManage` varchar(20) NOT NULL,
  `SellerAddr` varchar(100) NOT NULL,
  PRIMARY KEY (`sellerNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_shoppingmall.sellers:~10 rows (대략적) 내보내기
INSERT INTO `sellers` (`sellerNo`, `sellerBizName`, `sellerPhone`, `sellerManage`, `SellerAddr`) VALUES
...
INSERT INTO `users` (`userid`, `userName`, `userBirth`, `userGender`, `userHp`, `userEmail`, `userPoint`, `userLevel`, `userAddr`, `userRegDate`) VALUES
	...
	('user10', '허난설현', '1992-09-07', 'F', '010-7103-1992', NULL, 4100, 3, '광주', '2022-01-10 10:50:12'),
...
DROP DATABASE IF EXISTS `java1_university`;
CREATE DATABASE IF NOT EXISTS `java1_university` ;
...
-- 테이블 데이터 java1_university.departments:~12 rows (대략적) 내보내기
...
CREATE TABLE IF NOT EXISTS `lectures` (
  ...
  `Professors_proNo` char(6) NOT NULL,
  `lecName` varchar(45) NOT NULL,
  `lecCredit` tinyint NOT NULL,
  `lecTime` tinyint NOT NULL,
  `lecClass` varchar(45) NOT NULL,
  PRIMARY KEY (`lecNo`,`Professors_proNo`),
  KEY `fk_Lectures_Professors1_idx` (`Professors_proNo`),
  CONSTRAINT `fk_Lectures_Professors1` FOREIGN KEY (`Professors_proNo`) REFERENCES `professors` (`proNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_university.lectures:~10 rows (대략적) 내보내기
INSERT INTO `lectures` (`lecNo`, `Professors_proNo`, `lecName`, `lecCredit`, `lecTime`, `lecClass`) VALUES
...
CREATE TABLE IF NOT EXISTS `professors` (
  ...
  `Departments_depNo` char(2) NOT NULL,
  `proName` varchar(20) NOT NULL,
  `proJumin` char(14) NOT NULL,
  `proHp` char(14) NOT NULL,
  `proEmail` varchar(45) NOT NULL,
  `proAddr` varchar(100) NOT NULL,
  PRIMARY KEY (`proNo`),
  UNIQUE KEY `proHp_UNIQUE` (`proHp`),
  UNIQUE KEY `proJumin_UNIQUE` (`proJumin`),
  KEY `fk_Professors_Departments1_idx` (`Departments_depNo`),
  CONSTRAINT `fk_Professors_Departments1` FOREIGN KEY (`Departments_depNo`) REFERENCES `departments` (`depNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_university.professors:~12 rows (대략적) 내보내기
INSERT INTO `professors` (`proNo`, `Departments_depNo`, `proName`, `proJumin`, `proHp`, `proEmail`, `proAddr`) VALUES
...
DROP TABLE IF EXISTS `register`;
CREATE TABLE IF NOT EXISTS `register` (
  `Students_stdNo` char(8) NOT NULL,
  `Lectures_lecNo` char(6) NOT NULL,
  `Lectures_Professors_proNo` char(6) NOT NULL,
  ...
  PRIMARY KEY (`Students_stdNo`,`Lectures_lecNo`,`Lectures_Professors_proNo`),
  KEY `fk_Register_Lectures1_idx` (`Lectures_lecNo`,`Lectures_Professors_proNo`),
  CONSTRAINT `fk_Register_Lectures1` FOREIGN KEY (`Lectures_lecNo`, `Lectures_Professors_proNo`) REFERENCES `lectures` (`lecNo`, `Professors_proNo`),
  CONSTRAINT `fk_Register_Students1` FOREIGN KEY (`Students_stdNo`) REFERENCES `students` (`stdNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_university.register:~10 rows (대략적) 내보내기
INSERT INTO `register` (`Students_stdNo`, `Lectures_lecNo`, `Lectures_Professors_proNo`, `regAttenScore`, `regMidScore`, `regFinalScore`, `regTotal`, `regGrade`) VALUES
...
CREATE TABLE IF NOT EXISTS `students` (
  ...
  KEY `fk_Students_Professors_idx` (`Professors_proNo`),
  KEY `fk_Students_Departments1_idx` (`Departments_depNo`),
  CONSTRAINT `fk_Students_Departments1` FOREIGN KEY (`Departments_depNo`) REFERENCES `departments` (`depNo`),
  CONSTRAINT `fk_Students_Professors` FOREIGN KEY (`Professors_proNo`) REFERENCES `professors` (`proNo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- 테이블 데이터 java1_university.students:~12 rows (대략적) 내보내기
INSERT INTO `students` (`stdNo`, `Departments_depNo`, `Professors_proNo`, `stdName`, `stdJumin`, `stdHp`, `stdEmail`, `stdAddr`) VALUES
	('20101001', '10', 'P10101', '정우성', '760121-1234567', '010-1001-7601', NULL, '서울'),
...
CREATE DATABASE IF NOT EXISTS `java1db` ;
USE `java1db`;
...
-- 테이블 데이터 java1db.child:~1 rows (대략적) 내보내기
...
-- 테이블 데이터 java1db.member:~13 rows (대략적) 내보내기
INSERT INTO `member` (`uid`, `name`, `hp`, `pos`, `dep`, `rdate`) VALUES
	('a101', '박혁거세', '010-1234-1001', '부장', 102, '2022-08-24 11:58:26'),
	('a102', '김유신', '010-1234-1002', '차장', 101, '2022-08-24 11:58:31'),
	('a103', '김춘추', '010-1234-1003', '사원', 101, '2022-08-24 11:58:31'),
	('a104', '장보고', '010-1234-1004', '대리', 102, '2022-08-24 11:58:31'),
	('a105', '강감찬', '010-1234-1005', '과장', 102, '2022-08-24 11:58:31'),
	('a106', '이성계', '010-1234-1006', '차장', 103, '2022-08-24 11:58:31'),
	('a107', '정철', '010-1234-1007', '차장', 103, '2022-08-24 11:58:31'),
	('a108', '이순신', '010-1234-1008', '부장', 104, '2022-08-24 11:58:31'),
	('a109', '허균', '010-1234-1009', '부장', 104, '2022-08-24 11:58:31'),
	('a110', '정약용', '010-1234-1010', '사원', 105, '2022-08-24 11:58:31'),
	('a111', '박지원', '010-1234-1011', '사원', 105, '2022-08-24 11:58:31'),
	('b101', '을지문덕', '010-5555-1234', '사장', 107, '2022-08-25 11:11:11'),
	('Q123', '둘리', '010', '하사', 1, '1022-10-12 12:24:06');
...
-- 테이블 데이터 java1db.parent:~1 rows (대략적) 내보내기
...
INSERT INTO `tblproduct` (`prdCode`, `prdName`, `prdPrics`, `prdAmount`, `prdCompany`, `prdMakeDate`) VALUES
...
-- 테이블 데이터 java1db.tbluser:~4 rows (대략적) 내보내기
...
-- 테이블 데이터 java1db.user2:~6 rows (대략적) 내보내기
...
-- 테이블 데이터 java1db.user3:~5 rows (대략적) 내보내기
INSERT INTO `user3` (`uid`, `name`, `hp`, `age`) VALUES
	('a103', '김유진', '010-1234-1003', 24),
	('a999', '둘리', '011-1234-1111', 30),
	('Z001', '손오공', '000-0000-0001', 50),
	('Z002', '베지터', '000-0000-0002', 52),
	('Z003', '피콜로', '000-0000-0003', 28);
...
CREATE TABLE IF NOT EXISTS `user5` (
  ...
  `age` tinyint DEFAULT NULL,
  `addr` varchar(100) CHARACTER SET utf8mb4 DEFAULT NULL,
  `hp` char(13) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- 테이블 데이터 java1db.user5:~4 rows (대략적) 내보내기
INSERT INTO `user5` (`uid`, `name`, `birth`, `gender`, `age`, `addr`, `hp`) VALUES
	('A104', '손오공', '2022-10-23', 'null', 20, '옆집', '123'),
	('a522', '베지터', '2022-10-05', '1', 25, '앞집', '111111'),
	('db1', '손오반', '2022-10-04', '1', 5, '서울', ''),
	('q001', '고길동', '2016-02-24', '1', 51, '서울', '010');
...
-- 테이블 데이터 java1db.user6:~3 rows (대략적) 내보내기
INSERT INTO `user6` (`uid`, `name`, `birth`, `age`, `address`, `hp`) VALUES
	(NULL, '김유신', '0000-00-00', 1, NULL, NULL),
	(NULL, '김유신', '0000-00-00', 1, NULL, NULL),
	(NULL, '김춘추', '0000-00-00', 1, '부산시', NULL);
